...
const SongsSugestions = (): JSX.Element => {
    return (
        <section className='flex flex-col text-center mt-[-1px] px-6 py-10 bg-white-with-opacity items-center w-full bg-white'>
            ...
            <p className='tracking-widest leading-6 pt-4 lg:pt-8'>Como queremos que lo des todo en la pista de baile, queremos conocer tus preferencias musicales. ¡Cuentanos lo que te gusta!</p>
            <Link href='/songs'
