...
export const Presentation = (): JSX.Element => {
    ...
    const hasArrivedToMaxWith = useMediaQuery("(max-width: 1023px)", undefined, false);
    ...
    return (
        <section className="flex flex-col lg:items-center lg:flex-row w-full">
            ...
            { isMobile ? (
                <>
                    <Image src="/images/vivimosjuntos.jpg" alt={'Imagen de Vir y Seba en punta cana'} layout="fill" objectFit="cover" />
                </>
            ) : (
                <>
                    <Image src="/images/vivimosjuntos.jpg" alt={'Imagen de Vir y Seba en punta cana'} layout="fill" objectFit="cover" />
            ...
            <div className='w-full bg-white lg:py-[219px] lg:bg-white-with-opacity'>
                <div className="relative lg:static lg:flex-col">
                    ...
                    lg:static lg:-translate-x-0 lg:flex lg:justify-center">
                        {isMobile ? (
                            <Image src="/images/date-rings.svg" height={180} width={180} alt="Anillos entrelazados"/>
                        ) : (
                            <Image src="/images/date-rings-large.svg" height={108} width={150} alt="Anillos entrelazados"/>
                        )}
                    </div>
                </div>
                <div className="relative lg:static lg:flex-col ">
                    ...
                    <div className="border-y-2 border-y-primary-brown mx-6 mt-4 lg:mt-6 lg:mx-16">
                        <CountdownTimer date={new Date('2025-03-01T17:00:00')}/>
                    </div>
                    <div className="flex flex-col items-center p-10 relative lg:pt-12">
                        <audio controls>
                            <source src="/Novemberrain.mp3" type="audio/mpeg" />
                            Tu navegador no soporta el elemento de audio.
                        </audio>
                        {isMobile && (
                            <div className="flex flex-row justify-between items-center absolute w-full">
                                <Image src="/images/flowers-left.svg" alt="Flores de colores" width={106} height={163}/>
                                <Image src="/images/flowers-right.svg" alt="Flores de colores" width={88} height={159}/>
                            </div>
                        )}
                    </div>
                </div>
